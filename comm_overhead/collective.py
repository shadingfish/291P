...
-----------------------------------------------------------------------------
  ...
  ALL_REDUCE                 yes    yes*    yes            yes      TBD    yes
  ALL_GATHER                 yes    no**    yes            yes      TBD    yes
  REDUCE_SCATTER             yes    no**    yes            yes      TBD    yes
  BROADCAST                  yes    no**    yes            yes      TBD    yes
  ALL_TO_ALL                 yes    no**    yes***         yes      TBD    yes
